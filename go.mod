...
require (
	...
	gitlab.banksinarmas.com/go/sdkv2/authentication/auth v1.0.3
	gitlab.banksinarmas.com/go/sdkv2/authentication/integrations/activeDirectory v0.0.5
	gitlab.banksinarmas.com/go/sdkv2/common v1.3.0
	gitlab.banksinarmas.com/go/sdkv2/log/integrations/zap v1.6.4
	...
	gitlab.banksinarmas.com/go/sdkv2/webClient/webClient v1.0.0
	go.elastic.co/apm/module/apmgormv2/v2 v2.6.0
